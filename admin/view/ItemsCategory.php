            ...
            ?>
              <tr>
                ...
                <td class="text-center"><a href="index.php?page=update_items_category&id=<?php echo $pecah['IdCategory'] ?>" class="btn btn-warning btn-sm"><span class="fas fa-edit"></span> Ubah</a>
                  <a href="index.php?page=delete_items_category&id=<?php echo $pecah['IdCategory'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini...?')" class="btn btn-danger btn-sm"><span class="fas fa-trash"></span> Hapus</a>
              </tr>
              <?php $nomor++; ?>
            <?php
            }
