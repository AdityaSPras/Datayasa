...
<div class="container-fluid">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Divisi</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php
                                require_once '../koneksi.php';
                                $jumlah = "SELECT COUNT(*) FROM tb_division";
                                $data = mysqli_query($koneksi, $jumlah);
                                $row = mysqli_fetch_row($data);
                                echo $row[0];
                                mysqli_free_result($data);
    ...
    <div class="row">
        <div class="col-lg-12 card shadow">
            ...
            <div class="card-body">
                <h6 class="text-center"><b>SISTEM INFORMASI INVENTARIS BARANG DAN SERVICE PERANGKAT KOMPUTER</b><p>Anda Telah Login Sebagai <b><?php echo $_SESSION['Admin']['FullName']; ?></b></p>
                    <p>
                        <?php
